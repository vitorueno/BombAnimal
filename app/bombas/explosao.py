...
class Explosao_central(Explosao):
    def __init__(self,texture_list,center_x=0,center_y=0,angulo=0,img="app/img/explosao/explosao_central1.png"):
        super().__init__(texture_list,img,center_x,center_y,angulo)
    
class Explosao_trilho(Explosao):
    def __init__(self,texture_list,center_x=0,center_y=0,angulo=0,img="app/img/explosao/explosao_trilho1.png"):
        super().__init__(texture_list,img,center_x,center_y,angulo)

class Explosao_fim(Explosao):
    def __init__(self,texture_list,center_x=0,center_y=0,angulo=0,img="app/img/explosao/explosao_fim1.png"):
        super().__init__(texture_list,img,center_x,center_y,angulo)